...
{
    public partial class Form_DB_ThuNgan : Form
    {
        string MaNV;
        public Form_DB_ThuNgan(string maNV)
        {
            InitializeComponent();
            MaNV = maNV;
            ...
            UC_Account uc = new UC_Account(MaNV);
            addControls(uc);
        }
        ...
        {
            MovepanelSlide((Button)sender);
            UserControls.UC_HoaDon_ThuNgan uc = new UserControls.UC_HoaDon_ThuNgan(MaNV);
            addControls(uc);
        ...
        {
            MovepanelSlide((Button)sender);
            UserControls.UC_KH_ThuNgan uc = new UserControls.UC_KH_ThuNgan(MaNV);
            addControls(uc);
